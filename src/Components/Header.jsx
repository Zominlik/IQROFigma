...
const Header = () => {
    ...
    return (
        <header className="header sticky top-0 bg-green-700 z-10 flex shadow-md sticky top-0     xs:pl-[1rem] xs:pr-[1rem] xs:p-[1rem] xs:flex xs:justify-center xs:items-center xs:gap-[5rem]         sm:pl-[3rem] sm:pr-[3rem] sm:p-[2rem] sm:flex sm:justify-center sm:items-center sm:gap-[5rem]                       md:pl-[3rem] md:pr-[3rem] md:p-[2rem] md:gap-[2rem]            lg:pl-[3rem] lg:pr-[3rem] lg:p-[2rem] lg:gap-[4rem]             xl:pl-[3rem] xl:pr-[3rem] xl:p-[2rem] xl:gap-[6rem]             xxl:pl-[6rem] xxl:pr-[6rem] xxl:p-[2rem] xxl:gap-[13rem]     ">
